import mysql.connector as aviral   #install mysql connector "pip install mysql-connector"
from random import *
import datetime
...
try:
    ...
    global conn
    user_id=""
    conn=aviral.connect(host="localhost",user="root",passwd="Kanishk123@",database="rail_inq")
    cursor=conn.cursor()
    if user_id=="":
       log_sign()
    if user_id!="":
